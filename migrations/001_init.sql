...
CREATE TABLE IF NOT EXISTS fingerprints (
    ...
    peet_print TEXT NOT NULL DEFAULT '',
...
CREATE INDEX IF NOT EXISTS idx_fingerprints_username    ON fingerprints(username);
CREATE INDEX IF NOT EXISTS idx_fingerprints_client_hash ON fingerprints(client_hash);

CREATE TABLE IF NOT EXISTS blacklisted_ja3 (
    hash VARCHAR(32) PRIMARY KEY,
    reason VARCHAR(255) NOT NULL,
    created_at TIMESTAMP DEFAULT NOW()
);

INSERT INTO blacklisted_ja3 (hash, reason) VALUES
    ...
    ('d554db7fe99cd39d17867f8e55807610', 'Python3.17.3/mechanize'),
    ('c00f83d36bac03c69c9191fc15f33435', 'Python3.17.3/scrapy.crawler'),
    ('509c2af6543080daad20242bbc99fb74', 'Python3.17.3/urllib (stdlib)'),
    ('7292af3a71022d79a235ce81533e1091', 'Python3.17.3/urllib3'),
    ('709a372fb50304c473b66e41b406ea55', 'Python3.17.3/aiohttp')
